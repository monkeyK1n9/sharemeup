        ...
        <div className="flex flex-col justify-between bg-white h-full overflow-y-scrikk min-w-210 hide-scrollbar">
            ...
            {user && (
                <Link
                    ...
                    className="flex my-5 mb-3 gab-2 p-2 items-center bg-white rounded-lg shadow-lg mx-3"
                >
                    <img src={user.image} className="w-10 h-10 rounded-full mr-2" alt="User Profile" /> 
                    <p>{user.userName}</p>
                </Link>
            )}
        </div>
