            ...
            >
                ...
                {postHovered && (
                    ...
                    >
                        ...
                        <div className="flex justify-between items-center gap-2 w-full text-10">
                            {destination && (
                                <a
                                    href={destination}
                                    target="_blank"
                            ...
                            {postedBy?._id === userInfo.googleId && (
                                <button
                                    ...
                                    className='bg-white opacity-70 hover:opacity-100 text-dark font-bold p-2 text-base rounded-3xl hover:shadow-md outlined-none'
                                >
                                    <AiTwotoneDelete />
                                </button>
                            )}
